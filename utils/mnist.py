...
class DataUtils(object):
    ...
    def main():
        trainfile_X = '<path to train-images.idx3-ubyte>'
        trainfile_y = '<path to train-labels.idx1-ubyte>'
        testfile_X = '<path to t10k-images.idx3-ubyte>'
        testfile_y = '<path to t10k-labels.idx1-ubyte>'
        
        train_X = DataUtils(trainfile_X).get_image()
        train_y = DataUtils(trainfile_y).get_label()
        ...
        #DataUtils().out_img(train_X, train_y, outpath=path_testset, n=10)
        #DataUtils().out_img(test_X, test_y, outpath=path_testset, n=10)
    ...
    def out_img(self, arrX, arrY, outpath, n=1):
        """
